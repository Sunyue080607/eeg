...
<script>
    ...
    export default {
        ...
        computed: {
            ...mapState(["graghArr", 'myChart1vuex']),
            dateList: function () {
                return this.graghArr.map(function (item) {
                    return item[0];
                })
            },
            valueList: function () {
        ...
        methods: {
            ...mapMutations(['updatemyChart', 'updategraghArr', 'updatedata', 'updatedataoption']),
            getDay:function(num){
                var today = new Date();
            ...
            getSystemdata(){
               ...
               axios({
                ...
                //获取初始数据
                    this.$axios({
                        method: 'post',
                        url: 'http://'+GlobalMsg.ip+':8080/order/getcountBy'+urlx,
                        ...
                        that.updatemyChart(this.myChart1);
                        that.myChart1.setOption(this.Option);
                    }).catch((error) => {
                        console.log(error);
                    });
